...
c Version for FLEUR (FleurMaX Release 3 v0.27)
c
c --------------------------------------------
c
...
# include "cppmacro.h"
      ...
      character(*), parameter :: dftlong    = 'FleurMaX Release 3 v0.27'
      character(*), parameter :: dftshort   = 'fleurR3'
...
c ----------------------------------
      ...
      call hdf_rdwr_a(Hfile,'cell/scaleCell',0,latpar)
      ...
      call hdf_rdwr  (Hfile,'atoms/llo',     0,llo)
...
c ----------------------------------
      ...
      integer :: kgv
      call kpt_reorder1(0)
      iunit = fopen('kpts_gw',status='unknown')
      ...
      enddo
      call fclose(iunit)
      write(0,'(A)') 'File kpts_gw written.'
      call kpt_reorder2(0)
